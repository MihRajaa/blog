...
class ucp_controller
{
	...
	public function display_options()
	{
		...
		$data = [
			'user_demo' => $this->request->variable('user_demo', $this->user->data['user_demo']),
		];
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			if (!check_form_key('acme_demo_ucp'))
			{
			...
			if (empty($errors))
			{
				...
				$message = $this->language->lang('UCP_DEMO_SAVED') . '<br /><br />' . $this->language->lang('RETURN_UCP', '<a href="' . $this->u_action . '">', '</a>');
