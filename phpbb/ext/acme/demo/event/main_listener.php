...
class main_listener implements EventSubscriberInterface
{
	...
	/**
	 * Show users viewing Acme Demo page on the Who Is Online page
	 *
	 * @param \phpbb\event\data	$event	Event object
	 */
	 ...
	 * to allow only users with the a_new_acme_demo permission
	...
	public function add_permissions($event)
	{
		...
		$permissions['a_new_acme_demo'] = ['lang' => 'ACL_A_NEW_ACME_DEMO', 'cat' => 'misc'];
		$permissions['m_new_acme_demo'] = ['lang' => 'ACL_M_NEW_ACME_DEMO', 'cat' => 'post_actions'];
		$permissions['u_new_acme_demo'] = ['lang' => 'ACL_U_NEW_ACME_DEMO', 'cat' => 'post'];
