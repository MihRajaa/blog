...
class install_sample_data extends \phpbb\db\migration\migration
{
	...
	{
		return $this->config->offsetExists('acme_demo_sample_int');
	}
	...
	public function update_data()
	{
		return [
			...
			['config.add', ['acme_demo_sample_int', 0]],
			['config.add', ['acme_demo_sample_str', '']],

			// Add a new config_text table setting
			['config_text.add', ['acme_demo_sample', '']],

			// Add new permissions
			['permission.add', ['a_new_acme_demo']], // New admin permission
			['permission.add', ['m_new_acme_demo']], // New moderator permission
			['permission.add', ['u_new_acme_demo']], // New user permission
			...
			['permission.permission_set', ['ROLE_ADMIN_FULL', 'a_new_acme_demo']], // Give ROLE_ADMIN_FULL a_new_acme_demo permission
			['permission.permission_set', ['ROLE_MOD_FULL', 'm_new_acme_demo']], // Give ROLE_MOD_FULL m_new_acme_demo permission
			['permission.permission_set', ['ROLE_USER_FULL', 'u_new_acme_demo']], // Give ROLE_USER_FULL u_new_acme_demo permission
			['permission.permission_set', ['ROLE_USER_STANDARD', 'u_new_acme_demo']], // Give ROLE_USER_STANDARD u_new_acme_demo permission
			['permission.permission_set', ['REGISTERED', 'u_new_acme_demo', 'group']], // Give REGISTERED group u_new_acme_demo permission
			['permission.permission_set', ['REGISTERED_COPPA', 'u_new_acme_demo', 'group', false]], // Set u_new_acme_demo to never for REGISTERED_COPPA

			// Add new permission roles
			['permission.role_add', ['demo admin role', 'a_', 'a new role for admins']], // New role "demo admin role"
			['permission.role_add', ['demo moderator role', 'm_', 'a new role for moderators']], // New role "demo moderator role"
			['permission.role_add', ['demo user role', 'u_', 'a new role for users']], // New role "demo user role"
