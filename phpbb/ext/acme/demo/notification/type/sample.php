...
class sample extends \phpbb\notification\type\base
{
	...
	{
		return 'acme.demo.notification.type.sample';
	}
	...
	{
		return $this->language->lang('ACME_DEMO_NOTIFICATION');
	}
	...
	{
		return $this->helper->route('acme_demo_controller', $this->get_data('demo_sample_name'));
	}
	...
	{
		$this->set_data('demo_sample_name', $data['demo_sample_name']);
