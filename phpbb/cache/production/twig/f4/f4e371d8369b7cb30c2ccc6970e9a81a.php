...
/* mcp_queue.html */
class __TwigTemplate_899dadc818a6e4b27625b176f34486e1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t<li class=\"row";
                    // line 47
                    if ((twig_get_attribute($this->env, $this->source, $context["postrow"], "S_ROW_COUNT", [], "any", false, false, false, 47) % 2 != 0)) {
                        echo " bg1";
                    } else {
                        echo " bg2";
                    }
