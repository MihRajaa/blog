...
/* mcp_post.html */
class __TwigTemplate_9e2a353a1fa7c1b3427565e680802045 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["userrow"]) {
                    // line 291
                    echo "\t\t\t<tr class=\"";
                    if ((twig_get_attribute($this->env, $this->source, $context["userrow"], "S_ROW_COUNT", [], "any", false, false, false, 291) % 2 != 0)) {
                        echo "bg1";
                    } else {
                        echo "bg2";
                    }
...
\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["iprow"]) {
                    // line 320
                    echo "\t\t\t<tr class=\"";
                    if ((twig_get_attribute($this->env, $this->source, $context["iprow"], "S_ROW_COUNT", [], "any", false, false, false, 320) % 2 != 0)) {
                        echo "bg1";
                    } else {
                        echo "bg2";
                    }
