...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        $this->services['class_loader'] = $instance = new \phpbb\class_loader('phpbb\\', './../phpbb/includes/', 'php');
    ...
    {
        $this->services['class_loader.ext'] = $instance = new \phpbb\class_loader('\\', './../phpbb/ext/', 'php');
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'phpbb_blogdbconfig');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_blogdbconfig_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './../phpbb/', 'php', 'phpbb_blogdbforums', 'phpbb_blogdbposts', 'phpbb_blogdbtopics', 'phpbb_blogdbusers');
    }
    ...
    {
        return $this->services['controller.resolver'] = new \phpbb\controller\resolver($this, './../phpbb/', ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'});
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('phpbb_blogdbcaptcha_questions', 'phpbb_blogdbcaptcha_answers', 'phpbb_blogdbqa_confirm');
    ...
    {
        return $this->services['cron.manager'] = new \phpbb\cron\manager($this, ${($_ = isset($this->services['routing.helper']) ? $this->services['routing.helper'] : $this->getRouting_HelperService()) && false ?: '_'}, './../phpbb/', 'php', ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'});
    }
    ...
    {
        $this->services['cron.task.core.prune_forum'] = $instance = new \phpbb\cron\task\core\prune_forum('./../phpbb/', 'php', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'});
    ...
    {
        $this->services['cron.task.core.prune_shadow_topics'] = $instance = new \phpbb\cron\task\core\prune_shadow_topics('./../phpbb/', 'php', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'});
    ...
    {
        $this->services['cron.task.core.queue'] = $instance = new \phpbb\cron\task\core\queue('./../phpbb/', 'php', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, './../phpbb/cache/production/');
    ...
    {
        $this->services['cron.task.core.tidy_database'] = $instance = new \phpbb\cron\task\core\tidy_database('./../phpbb/', 'php', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'});
    ...
    {
        $this->services['cron.task.core.tidy_plupload'] = $instance = new \phpbb\cron\task\core\tidy_plupload('./../phpbb/', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'});
    ...
    {
        $this->services['cron.task.core.tidy_search'] = $instance = new \phpbb\cron\task\core\tidy_search('./../phpbb/', 'php', ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'});
    ...
    {
        $this->services['cron.task.core.tidy_warnings'] = $instance = new \phpbb\cron\task\core\tidy_warnings('./../phpbb/', 'php', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'});
    ...
    {
        return new \phpbb\db\extractor\mssql_extractor('./../phpbb/', ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn.driver']) ? $this->services['dbal.conn.driver'] : $this->get('dbal.conn.driver', 1)) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\db\extractor\mysql_extractor('./../phpbb/', ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn.driver']) ? $this->services['dbal.conn.driver'] : $this->get('dbal.conn.driver', 1)) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\db\extractor\oracle_extractor('./../phpbb/', ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn.driver']) ? $this->services['dbal.conn.driver'] : $this->get('dbal.conn.driver', 1)) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\db\extractor\postgres_extractor('./../phpbb/', ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn.driver']) ? $this->services['dbal.conn.driver'] : $this->get('dbal.conn.driver', 1)) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\db\extractor\sqlite3_extractor('./../phpbb/', ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn.driver']) ? $this->services['dbal.conn.driver'] : $this->get('dbal.conn.driver', 1)) && false ?: '_'});
    }
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'phpbb_blogdbext', './../phpbb/', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['feed.quote_helper'] = new \phpbb\feed\quote_helper(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './../phpbb/', 'php');
    }
    ...
    {
        return $this->services['file_locator'] = new \phpbb\routing\file_locator(${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, './../phpbb/');
    }
    ...
    {
        return new \phpbb\files\types\remote(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['files.factory']) ? $this->services['files.factory'] : ($this->services['files.factory'] = new \phpbb\files\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['php_ini']) ? $this->services['php_ini'] : ($this->services['php_ini'] = new \bantu\IniGetWrapper\IniGetWrapper())) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, './../phpbb/');
    }
    ...
    {
        return $this->services['hook_finder'] = new \phpbb\hook\finder('./../phpbb/', 'php', ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'});
    }
    ...
    {
        return $this->services['language.helper.language_file'] = new \phpbb\language\language_file_helper('./../phpbb/');
    }
    ...
    {
        $this->services['language.loader'] = $instance = new \phpbb\language\language_file_loader('./../phpbb/', 'php');
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager(${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['ext.manager']) ? $this->services['ext.manager'] : $this->getExt_ManagerService()) && false ?: '_'}, 'phpbb_blogdbmodules', './../phpbb/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../phpbb/', 'php', 'phpbb_blogdbnotification_emails');
    }
    ...
    {
        return new \phpbb\notification\method\jabber(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, './../phpbb/', 'php');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './../phpbb/', 'php', 'phpbb_blogdbuser_notifications');
    ...
    {
        return $this->services['path_helper'] = new \phpbb\path_helper(${($_ = isset($this->services['symfony_request']) ? $this->services['symfony_request'] : $this->getSymfonyRequestService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, './../phpbb/', 'php', 'adm/');
    }
    ...
    {
        return $this->services['phpbb.skeleton.helper.packager'] = new \phpbb\skeleton\helper\packager($this, ${($_ = isset($this->services['phpbb.skeleton.collection']) ? $this->services['phpbb.skeleton.collection'] : $this->getPhpbb_Skeleton_CollectionService()) && false ?: '_'}, './../phpbb/');
    }
    ...
    {
        return $this->services['plupload'] = new \phpbb\plupload\plupload('./../phpbb/', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['php_ini']) ? $this->services['php_ini'] : ($this->services['php_ini'] = new \bantu\IniGetWrapper\IniGetWrapper())) && false ?: '_'}, ${($_ = isset($this->services['mimetype.guesser']) ? $this->services['mimetype.guesser'] : $this->getMimetype_GuesserService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_blogdbprofile_fields_lang');
    }
    ...
    {
        return $this->services['routing.helper'] = new \phpbb\routing\helper(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['router']) ? $this->services['router'] : $this->getRouterService()) && false ?: '_'}, ${($_ = isset($this->services['symfony_request']) ? $this->services['symfony_request'] : $this->getSymfonyRequestService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, './../phpbb/', 'php');
    }
    ...
    {
        return $this->services['routing.resources_locator.default'] = new \phpbb\routing\resources_locator\default_resources_locator('./../phpbb/', 'production', ${($_ = isset($this->services['ext.manager']) ? $this->services['ext.manager'] : $this->getExt_ManagerService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_blogdbbbcodes', 'phpbb_blogdbsmilies', 'phpbb_blogdbstyles', 'phpbb_blogdbwords', './../phpbb/styles/');
    }
    ...
    {
        return $this->services['text_formatter.s9e.quote_helper'] = new \phpbb\textformatter\s9e\quote_helper(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './../phpbb/', 'php');
    }
    ...
    {
        $this->services['text_formatter.s9e.renderer'] = $instance = new \phpbb\textformatter\s9e\renderer(${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, './../phpbb/cache/production/', '_text_formatter_renderer', ${($_ = isset($this->services['text_formatter.s9e.factory']) ? $this->services['text_formatter.s9e.factory'] : $this->getTextFormatter_S9e_FactoryService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'});
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_blogdbforums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_blogdbforums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_blogdbgroups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_blogdbprivmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_blogdbpoll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_blogdbtopics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_blogdbposts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_blogdbusers');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../phpbb/', 'php', 'phpbb_blogdbusers');
    }
    ...
    {
        return [
            'core.root_path' => './../phpbb/',
            'core.php_ext' => 'php',
            'core.environment' => 'production',
            'core.debug' => false,
            'core.cache_dir' => './../phpbb/cache/production/',
            ...
            'text_formatter.cache.dir' => './../phpbb/cache/production/',
            'text_formatter.cache.parser.key' => '_text_formatter_parser',
            'text_formatter.cache.renderer.key' => '_text_formatter_renderer',
            'core.template.cache_path' => './../phpbb/cache/production/twig/',
            'tables.acl_groups' => 'phpbb_blogdbacl_groups',
            'tables.acl_options' => 'phpbb_blogdbacl_options',
            'tables.acl_roles' => 'phpbb_blogdbacl_roles',
            'tables.acl_roles_data' => 'phpbb_blogdbacl_roles_data',
            'tables.acl_users' => 'phpbb_blogdbacl_users',
            'tables.attachments' => 'phpbb_blogdbattachments',
            'tables.auth_provider_oauth_token_storage' => 'phpbb_blogdboauth_tokens',
            'tables.auth_provider_oauth_states' => 'phpbb_blogdboauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'phpbb_blogdboauth_accounts',
            'tables.banlist' => 'phpbb_blogdbbanlist',
            'tables.bbcodes' => 'phpbb_blogdbbbcodes',
            'tables.bookmarks' => 'phpbb_blogdbbookmarks',
            'tables.bots' => 'phpbb_blogdbbots',
            'tables.captcha_qa_questions' => 'phpbb_blogdbcaptcha_questions',
            'tables.captcha_qa_answers' => 'phpbb_blogdbcaptcha_answers',
            'tables.captcha_qa_confirm' => 'phpbb_blogdbqa_confirm',
            'tables.config' => 'phpbb_blogdbconfig',
            'tables.config_text' => 'phpbb_blogdbconfig_text',
            'tables.confirm' => 'phpbb_blogdbconfirm',
            'tables.disallow' => 'phpbb_blogdbdisallow',
            'tables.drafts' => 'phpbb_blogdbdrafts',
            'tables.ext' => 'phpbb_blogdbext',
            'tables.extensions' => 'phpbb_blogdbextensions',
            'tables.extension_groups' => 'phpbb_blogdbextension_groups',
            'tables.forums' => 'phpbb_blogdbforums',
            'tables.forums_access' => 'phpbb_blogdbforums_access',
            'tables.forums_track' => 'phpbb_blogdbforums_track',
            'tables.forums_watch' => 'phpbb_blogdbforums_watch',
            'tables.groups' => 'phpbb_blogdbgroups',
            'tables.icons' => 'phpbb_blogdbicons',
            'tables.lang' => 'phpbb_blogdblang',
            'tables.log' => 'phpbb_blogdblog',
            'tables.login_attempts' => 'phpbb_blogdblogin_attempts',
            'tables.migrations' => 'phpbb_blogdbmigrations',
            'tables.moderator_cache' => 'phpbb_blogdbmoderator_cache',
            'tables.modules' => 'phpbb_blogdbmodules',
            'tables.notification_emails' => 'phpbb_blogdbnotification_emails',
            'tables.notification_types' => 'phpbb_blogdbnotification_types',
            'tables.notifications' => 'phpbb_blogdbnotifications',
            'tables.poll_options' => 'phpbb_blogdbpoll_options',
            'tables.poll_votes' => 'phpbb_blogdbpoll_votes',
            'tables.posts' => 'phpbb_blogdbposts',
            'tables.privmsgs' => 'phpbb_blogdbprivmsgs',
            'tables.privmsgs_folder' => 'phpbb_blogdbprivmsgs_folder',
            'tables.privmsgs_rules' => 'phpbb_blogdbprivmsgs_rules',
            'tables.privmsgs_to' => 'phpbb_blogdbprivmsgs_to',
            'tables.profile_fields' => 'phpbb_blogdbprofile_fields',
            'tables.profile_fields_data' => 'phpbb_blogdbprofile_fields_data',
            'tables.profile_fields_options_language' => 'phpbb_blogdbprofile_fields_lang',
            'tables.profile_fields_language' => 'phpbb_blogdbprofile_lang',
            'tables.ranks' => 'phpbb_blogdbranks',
            'tables.reports' => 'phpbb_blogdbreports',
            'tables.reports_reasons' => 'phpbb_blogdbreports_reasons',
            'tables.search_results' => 'phpbb_blogdbsearch_results',
            'tables.search_wordlist' => 'phpbb_blogdbsearch_wordlist',
            'tables.search_wordmatch' => 'phpbb_blogdbsearch_wordmatch',
            'tables.sessions' => 'phpbb_blogdbsessions',
            'tables.sessions_keys' => 'phpbb_blogdbsessions_keys',
            'tables.sitelist' => 'phpbb_blogdbsitelist',
            'tables.smilies' => 'phpbb_blogdbsmilies',
            'tables.sphinx' => 'phpbb_blogdbsphinx',
            'tables.styles' => 'phpbb_blogdbstyles',
            'tables.styles_template' => 'phpbb_blogdbstyles_template',
            'tables.styles_template_data' => 'phpbb_blogdbstyles_template_data',
            'tables.styles_theme' => 'phpbb_blogdbstyles_theme',
            'tables.styles_imageset' => 'phpbb_blogdbstyles_imageset',
            'tables.styles_imageset_data' => 'phpbb_blogdbstyles_imageset_data',
            'tables.teampage' => 'phpbb_blogdbteampage',
            'tables.topics' => 'phpbb_blogdbtopics',
            'tables.topics_posted' => 'phpbb_blogdbtopics_posted',
            'tables.topics_track' => 'phpbb_blogdbtopics_track',
            'tables.topics_watch' => 'phpbb_blogdbtopics_watch',
            'tables.user_group' => 'phpbb_blogdbuser_group',
            'tables.user_notifications' => 'phpbb_blogdbuser_notifications',
            'tables.users' => 'phpbb_blogdbusers',
            'tables.warnings' => 'phpbb_blogdbwarnings',
            'tables.words' => 'phpbb_blogdbwords',
            'tables.zebra' => 'phpbb_blogdbzebra',
            ...
            'tables' => [
                ...
                'acl_roles' => 'phpbb_blogdbacl_roles',
                'acl_roles_data' => 'phpbb_blogdbacl_roles_data',
                'acl_users' => 'phpbb_blogdbacl_users',
                'attachments' => 'phpbb_blogdbattachments',
                'auth_provider_oauth_token_storage' => 'phpbb_blogdboauth_tokens',
                'auth_provider_oauth_states' => 'phpbb_blogdboauth_states',
                'auth_provider_oauth_account_assoc' => 'phpbb_blogdboauth_accounts',
                'banlist' => 'phpbb_blogdbbanlist',
                'bbcodes' => 'phpbb_blogdbbbcodes',
                'bookmarks' => 'phpbb_blogdbbookmarks',
                'bots' => 'phpbb_blogdbbots',
                'captcha_qa_questions' => 'phpbb_blogdbcaptcha_questions',
                'captcha_qa_answers' => 'phpbb_blogdbcaptcha_answers',
                'captcha_qa_confirm' => 'phpbb_blogdbqa_confirm',
                'config' => 'phpbb_blogdbconfig',
                'config_text' => 'phpbb_blogdbconfig_text',
                'confirm' => 'phpbb_blogdbconfirm',
                'disallow' => 'phpbb_blogdbdisallow',
                'drafts' => 'phpbb_blogdbdrafts',
                'ext' => 'phpbb_blogdbext',
                'extensions' => 'phpbb_blogdbextensions',
                'extension_groups' => 'phpbb_blogdbextension_groups',
                'forums' => 'phpbb_blogdbforums',
                'forums_access' => 'phpbb_blogdbforums_access',
                'forums_track' => 'phpbb_blogdbforums_track',
                'forums_watch' => 'phpbb_blogdbforums_watch',
                'groups' => 'phpbb_blogdbgroups',
                'icons' => 'phpbb_blogdbicons',
                'lang' => 'phpbb_blogdblang',
                'log' => 'phpbb_blogdblog',
                'login_attempts' => 'phpbb_blogdblogin_attempts',
                'migrations' => 'phpbb_blogdbmigrations',
                'moderator_cache' => 'phpbb_blogdbmoderator_cache',
                'modules' => 'phpbb_blogdbmodules',
                'notification_emails' => 'phpbb_blogdbnotification_emails',
                'notification_types' => 'phpbb_blogdbnotification_types',
                'notifications' => 'phpbb_blogdbnotifications',
                'poll_options' => 'phpbb_blogdbpoll_options',
                'poll_votes' => 'phpbb_blogdbpoll_votes',
                'posts' => 'phpbb_blogdbposts',
                'privmsgs' => 'phpbb_blogdbprivmsgs',
                'privmsgs_folder' => 'phpbb_blogdbprivmsgs_folder',
                'privmsgs_rules' => 'phpbb_blogdbprivmsgs_rules',
                'privmsgs_to' => 'phpbb_blogdbprivmsgs_to',
                'profile_fields' => 'phpbb_blogdbprofile_fields',
                'profile_fields_data' => 'phpbb_blogdbprofile_fields_data',
                'profile_fields_options_language' => 'phpbb_blogdbprofile_fields_lang',
                'profile_fields_language' => 'phpbb_blogdbprofile_lang',
                'ranks' => 'phpbb_blogdbranks',
                'reports' => 'phpbb_blogdbreports',
                'reports_reasons' => 'phpbb_blogdbreports_reasons',
                'search_results' => 'phpbb_blogdbsearch_results',
                'search_wordlist' => 'phpbb_blogdbsearch_wordlist',
                'search_wordmatch' => 'phpbb_blogdbsearch_wordmatch',
                'sessions' => 'phpbb_blogdbsessions',
                'sessions_keys' => 'phpbb_blogdbsessions_keys',
                'sitelist' => 'phpbb_blogdbsitelist',
                'smilies' => 'phpbb_blogdbsmilies',
                'sphinx' => 'phpbb_blogdbsphinx',
                'styles' => 'phpbb_blogdbstyles',
                'styles_template' => 'phpbb_blogdbstyles_template',
                'styles_template_data' => 'phpbb_blogdbstyles_template_data',
                'styles_theme' => 'phpbb_blogdbstyles_theme',
                'styles_imageset' => 'phpbb_blogdbstyles_imageset',
                'styles_imageset_data' => 'phpbb_blogdbstyles_imageset_data',
                'teampage' => 'phpbb_blogdbteampage',
                'topics' => 'phpbb_blogdbtopics',
                'topics_posted' => 'phpbb_blogdbtopics_posted',
                'topics_track' => 'phpbb_blogdbtopics_track',
                'topics_watch' => 'phpbb_blogdbtopics_watch',
                'user_group' => 'phpbb_blogdbuser_group',
                'user_notifications' => 'phpbb_blogdbuser_notifications',
                'users' => 'phpbb_blogdbusers',
