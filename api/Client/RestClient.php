...
require 'E:/xampp/htdocs/blog/phpbb/ext/eparsons/restapi/vendor/autoload.php';
require 'E:/xampp/htdocs/blog/phpbb/vendor/autoload.php';
...
class Forum
{
    ...
    private $apiPath = "https://localhost/blog/phpbb/app.php/restApiV1/";
    ...
    public function login($username, $password, $autoLogin = false)
    {
        ...
        $client = new Client(['base_uri' => 'https://localhost/blog/api/']);
